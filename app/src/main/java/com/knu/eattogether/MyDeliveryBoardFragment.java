...
public class MyDeliveryBoardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_my_delivery_board, container, false);

        deliveryRecyclerView = view.findViewById(R.id.my_deliveryboard_recyclerview); // 아이디 연결
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1 : snapshot.getChildren()){
                    ...
                    if(userid.equals(item1.getUserid())) {
                        ...
                        Collections.sort(plist, new MyDeliveryBoardFragment.Ascending());
