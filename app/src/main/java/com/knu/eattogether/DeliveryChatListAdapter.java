...
public class DeliveryChatListAdapter extends RecyclerView.Adapter<DeliveryChatListAdapter.ViewHolder> {
    ...
    public DeliveryChatListAdapter(Context context, List<ChatListItem> mDataList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull DeliveryChatListAdapter.ViewHolder holder, int position) {
        auth = FirebaseAuth.getInstance();
        myid = auth.getUid();

        DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference("DeliveryPost").child(mDataList.get(position).getPostid());
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("DeliveryChat").child(mDataList.get(position).getPostid());
        ...
        public ViewHolder(@NonNull @NotNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(v.getContext(), DeliveryChattingActivity.class);
